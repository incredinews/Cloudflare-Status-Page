...
//
  ...
  let myhtml:string = '<link href="assets/upcloudflare.css" type="text/css" rel="stylesheet"><script>window.realapihost="'+`${config.settings.url}`+'"</script> \n \
    <div id="actiondiv" >About</div><script src="/assets/d3.v7.min.js"></script><script src="/assets/d3-array.v2.min.js"></script><script src="/assets/d3-scale-chromatic.v1.min.js"></script><script src="/assets/loadUptimeData.js"></script><script>console.log("loaded d3")</script> \n \
