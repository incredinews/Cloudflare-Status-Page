...
//  )
  ...
  //const response = new NextResponse(`<html>yourfile</html>`)
  //// There is no content-type by default!
  //response.headers.set('Content-Type', 'text/html; charset=utf-8');
//
  //// set response headers, cookies, etc, if desired
  //return response;
  let myhtml:string = '<link href="assets/upcloudflare.css" type="text/css" rel="stylesheet"><script>window.realapihost="'+`${config.settings.url}`+'"</script> \n \
    <script src="/assets/d3.v7.min.js"></script><script src="/assets/d3-array.v2.min.js"></script><script src="/assets/d3-scale-chromatic.v1.min.js"></script><script src="/assets/loadUptimeData.js"></script><script>console.log("loaded d3")</script> \n \
    <div id=statusheader class="MuiStack-root mui-1ialerq"><p id="textStatus" class="MuiTypography-root MuiTypography-body1 mui-gjwoc1" style="color: rgb(255, 255, 255); text-align: right;"> </p><h1 id="mainstatustxt" class="MuiTypography-root MuiTypography-h3 mui-il834h" style="color: rgb(255, 255, 255); text-align: left;">Loading</h1><p id="mainstatusago" class="MuiTypography-root MuiTypography-body1 mui-gjwoc1" style="color: rgb(255, 255, 255); text-align: right;">0 Seconds ago</p><p class="MuiTypography-root MuiTypography-body1 mui-gjwoc1" style="color: rgb(255, 238, 255); text-align: left;">  </p></div>  \n \
...
//     <p class="recharts-tooltip-label" style="margin: 0px; color: rgb(0, 0, 0);">2025-06-19</p></div></div></div></div></div></div></div>    \n \
  //return {myhtml}
